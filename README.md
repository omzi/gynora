...
- **_AI Models_**: OpenAI's GPT-4o Mini, Google's Gemini 1.5 Flash, OpenAI's TTS-1, OpenAI's Whisper
...
Gynora is a work-in-progress submitted to the [AfroTech AI hackathon](https://afrotech.devpost.com/). You may experience rate limits, errors and/or bugs while testing out the application. Feel free to reach to me on Twitter ([@0xOmzi](https://twitter.com/0xOmzi)) regarding any issue you might be facing.
